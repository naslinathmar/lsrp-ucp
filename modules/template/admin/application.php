							...
							<section class="cstwothirds transparent nopadding">
								...
								<?php if($status == 0 && $noperm == false) { ?>
									<div class="buttons">
										...
										<app-button _ngcontent-tnh-c145="" caption="Freeze" icon="fa-eye" class="blue" _nghost-tnh-c216="" onClick="document.location.href='https://www.legacy-rp.net/modules/template/admin/application/review.php?app_id=<?php echo $app_id; ?>'">
											<div _ngcontent-tnh-c216="" class="btn-wrapper">
												<div _ngcontent-tnh-c216="" class="button">	
							...
							<section class="nopadding transparent csthird">
								<section class="card">
									...
									<table class="onedimension" cellspacing="0">
										...
										<tr>
											<td>IP Address</td>
											<td><a [routerLink]="[\'https://www.legacy-rp.net/admin/ip\', app.ip]" target="_blank"><?php echo $ip_address; ?></a></td> </tr>
										<tr>
											<td>Country</td>
											<td><img src="https://www.legacy-rp.net/assets/images/flags/<?php echo strtolower($country_code); ?>.svg" width="24" height="24" align="center"> <?php echo $country; ?> </td> </tr> </table> </section>
								<section class="card margin-top-10">
									<div class="card-title"> Flags </div>
									<ul class="flags">
									<?php if(strlen($flag_5) > 0) { ?>
									<li class="warning cursor-pointer">           <i class="icon fa fa-fw fa-file color-blue"></i>             <a href="https://www.legacy-rp.net/admin/application/<?php echo $sim; ?>" target="_blank"><?php echo $flag_5; ?></a>                    </li>
									<?php } ?>									
								...
								<section class="card margin-top-10" *ngIf="app.main_account && app.main_account.users">
									...
									for($i = 0; $i < count($PastApplications); ++$i)
									{
										...
										?>
										<div class="description"> <a href="https://www.legacy-rp.net/admin/application/<?php echo $PastApplications[$i]["id"]; ?>" target="_blank">#<?php echo $PastApplications[$i]["id"]; ?> <?php echo $PastApplications[$i]["char_name"]; ?></a><span style="float: right; padding-right: 10px;"><strong><?php echo $PastApplications[$i]["the_status"]; ?></strong></span> </div> 
										<?php
									}
