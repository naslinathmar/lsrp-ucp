...
if($rowcount == 0)
{
	header("location: https://www.legacy-rp.net/admin/applications");
	exit();
}
...
$body = "Dear $masterrr,<br><br>Your character application for <strong><a href='https://www.legacy-rp.net/panel/applications/$app_id'>$char_name</a></strong> has been denied for the following reason: <em>$clean_verdict</em>. <br><br>Please switch to your character for more details.<br><br>Regards,<br>Legacy Role Play";
...
header("location: https://www.legacy-rp.net/admin/application/$app_id");
