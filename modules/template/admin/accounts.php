						...
						$("#look_up_results").load("http://www.legacy-rp.net/admin/search_results.php?search_type=2&search_input=" + "<?php echo $_GET['app_id']; ?>", function() 
						{														
                                        ...
                                        <table _ngcontent-tnh-c167="" cellspacing="0">
											...
											<?php
													...
													<tr _ngcontent-tnh-c167="" id="kari" <?php if($banned == true) { ?>class="color-red"<?php } ?>>
														...
														<td _ngcontent-tnh-c167=""><span _ngcontent-tnh-c167=""><a href="http://www.legacy-rp.net/admin/accounts/<?php echo $Username; ?>" target="_blank"><?php echo $Username; ?></a></span></td>
