					...
					<div _ngcontent-tnh-c145="" class="content-header" *ngIf="property">
						...
						<app-button _ngcontent-tnh-c145="" caption="Spawn Here" icon="fa-compass" class="fl-ri blue" _nghost-tnh-c216="" onClick="document.location.href='https://www.legacy-rp.net/panel/property/<?php echo $carsqlid; ?>/changespawn';">
							<div _ngcontent-tnh-c216="" class="btn-wrapper">
								<div _ngcontent-tnh-c216="" class="button">
				...
				<div _ngcontent-tnh-c145="" class="content" *ngIf="property && !slug">
					...
					<div _ngcontent-tnh-c219="" class="cs-1 map-section" width="200" style="background-image: url(&quot;https://www.legacy-rp.net/map/?x=<?php echo $result2['posx']; ?>&y=<?php echo $result2['posy']; ?>&quot;); background-position: calc(-70px) calc(-5px);">
					...
					<section class="csthird" *ngIf="property.apartments.length" style="background-image: url(&quot;https://www.legacy-rp.net/map/?x=<?php echo $result2['posx']; ?>&y=<?php echo $result2['posy']; ?>&quot;); background-position: calc(0px) calc(65px);">
