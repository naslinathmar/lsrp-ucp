                       ...
                       <app-settings _nghost-tnh-c144="">
						...
						<section class="content-header" *ngIf="application">
                            ...
                            <!--<app-button _ngcontent-tnh-c145="" caption="Withdraw Application" icon="fa-trash" class="fl-ri blue margin-left-10" _nghost-tnh-c216="" onClick="window.location.href='https://www.legacy-rp.net/panel/applications/<?php echo $application_id; ?>/withdraw'" onclick="">
						...
						<div class="content" *ngIf="application">
							...
							<section class="csthird transparent nopadding text-center"> <img src="https://www.legacy-rp.net/assets/skins_small/<?php echo $ApplicationData['skin']; ?>-240-400.png"> 							</section>
						</div>					   					   					  
                        </app-settings>
                        <!---->
