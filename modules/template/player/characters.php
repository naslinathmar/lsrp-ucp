...
<app-character-list _nghost-tnh-c142="">
	...
	if($app_count > 0)
	{
		for($i = 0; $i < $app_count; ++$i)
		{
			...
			?>	
			<section _ngcontent-tnh-c142="" class="character_preview nopadding transparent csquarterthird frozen" onClick="changeCurrentPage('applications', '<?php echo $appdata[$i]['ID']; ?>', 4)" style="background-image: url(&quot;https://www.legacy-rp.net/assets/skins/<?php echo $appdata[$i]['skin']; ?>-380-600.png&quot;);">
	...
	if($char_count > 0)
	{
		for($i = 0; $i < $char_count; ++$i)
		{
			...
			for($x = 0; $x < sizeof($serverSkins); ++$x)
			{
				...
				<section _ngcontent-tnh-c142="" class="character_preview csquarterthird" tabindex="0" onClick="changeCurrentPage('characters', '<?php echo $userii; ?>', 1)" style="background-image: url(&quot;https://www.legacy-rp.net/assets/skins/<?php echo $Model; ?>-380-600.png&quot;);">										
