						...
						if($rowcount == 0)
						{
							...
							//echo '<script>window.location.href = "https://www.legacy-rp.net/panel/characters";</script>';
                        ...
                        <app-character _nghost-tnh-c145="">
                            ...
                            <div _ngcontent-tnh-c145="" class="content">
								...
								?>
									<div _ngcontent-tnh-c145="" class="text-center"><img _ngcontent-tnh-c145="" src="https://www.legacy-rp.net/assets/skins_small/<?php echo $Model; ?>-240-400.png"></div>
								</section>
                                ...
                                <section _ngcontent-tnh-c145="" class="transparent csquarterthird vehicle cursor-pointer" tabindex="0" onClick="changeCurrentPage('vehicle', '<?php echo $carID; ?>', 6)">
                                    <app-model-preview _ngcontent-tnh-c145="" scene="vehicle" padding="20" class="color-blue" _nghost-tnh-c166="">
                                        <div _ngcontent-tnh-c166="" class="previewContainer">
                                            <div _ngcontent-tnh-c166="" class="preview" style="background-image: url(&quot;https://www.legacy-rp.net/vehicles/<?php echo $carModel; ?>.png&quot;); top: 20px; bottom: 20px; left: 20px; right: 20px;"></div>
                                            <!---->
                                            ...
                                            <div _ngcontent-tnh-c145="" title="Vehicle can be viewed in Virtual Garage" class="virtual-garage" onClick="window.location.href = 'https://www.legacy-rp.net/panel/garage/<?php echo $carID; ?>';"><i _ngcontent-tnh-c145="" class="fa fa-fw fa-car-garage"></i></div>
                                            <!---->
                                        </div>
									</app-model-preview>
                                </section>
                            ...
                            "background-position": "calc(50% - " + Math.floor(t - n) + "px) calc(50% - " + Math.floor(e - r) + "px)"
									...
									?>
										...
										<div _ngcontent-tnh-c219="" class="map-section" style="background-image: url(&quot;https://www.legacy-rp.net/map/?x=<?php echo $posi_x; ?>&y=<?php echo $posi_y; ?>&quot;); background-position: calc(-70px) calc(-5px);" onClick="changeCurrentPage('property', '<?php echo $houseid; ?>', 10)">
											<div _ngcontent-tnh-c166="" class="marker house" style="background: url('https://www.legacy-rp.net/mapicons/house.gif'); background-size: 100%; background-repeat: no-repeat;"></div>						
											...
											<div _ngcontent-tnh-c166="" class="padding-5">
												...
												<app-button _ngcontent-tnh-c145="" caption="Spawn Here" icon="fa-file-contract" class="fl-ri color-white thin blue shadow" _nghost-tnh-c216="" onClick="document.location.href='https://www.legacy-rp.net/panel/property/<?php echo $houseid; ?>/changespawn';">
