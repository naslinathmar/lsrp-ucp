						...
						{																		
							...
							if(!empty($_GET['delete']) && is_numeric($_GET['delete']))
							{
								if($_GET['delete'] == 1)
								{
									...
									//header("Location: https://www.legacy-rp.net/panel/inbox/");
									echo '<script>window.location.href = "https://www.legacy-rp.net/panel/inbox/";</script>';
									exit;		
								}
							}
                        ...
                        <app-message _nghost-tnh-c172="">
                            <div _ngcontent-tnh-c172="" class="content-header">
                                ...
                                <app-button _ngcontent-tnh-c172="" icon="fa fa-trash-alt" caption="Delete" class="fl-ri tomato" _nghost-tnh-c216="" onclick="document.location.href='https://www.legacy-rp.net/panel/inbox/<?php echo $notifid; ?>&delete=1'">
