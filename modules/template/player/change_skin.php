                        ...
                        <app-character _nghost-tnh-c145="">	
                            ...
                            <div _ngcontent-tnh-c145="" class="content">
                                    ...
                                    <iframe _ngcontent-tnh-c163="" name="<?php echo $skins[ $Model ]; ?>" class="scene" id="skin_src" src="https://www.legacy-rp.net/assets/skins_small/<?php echo $skinipau; ?>-240-400.png" scrolling="no"></iframe>
						...
						{
							$.post('https://www.legacy-rp.net/api/skinload.php', {race: f_skin_race, gender: f_skin_gender, weight: f_skin_weight, category: f_skin_category, faction_id: faction}).done(function(response) 
							{
								...
								for (i = 0; i < length; i++) 
								{
									...
									link = "https://www.legacy-rp.net/assets/skins_small/" + data[i]['name'] + '-240-400.png'; 
						...
						{
							var test = "https://www.legacy-rp.net/assets/skins_small/" + skinname + "-240-400.png", src_idx = document.getElementById("skin_src");
						...
						function saveThisSkin2(playerid) 
						{
							...
							document.location.href = 'https://www.legacy-rp.net/panel/change_skin/' + playerid + '/' + skinid;
						}			
