		...
		if($adminlevel >= 1 || strlen($story) > 200)
		{
			...
			{	
				if($adminlevel > 0)
				{
					...
					echo "<script>document.location.href='https://www.legacy-rp.net/panel/characters'</script>";
					exit;
				}
				else
				{
					...
					Discord_AlertStaff("@here A new character application has just been submitted by **$username**! https://www.legacy-rp.net/admin/application/$app_id"); 
...
<app-settings _nghost-tnh-c144="">				
	...
	<form action="https://www.legacy-rp.net/panel/create-character" method="post" name="forma_char" id="appi_test"></form>	
	<div class="content">
		...
		<section class="card cshalf"> 
			...
			<div class="skin-container">
				...
				{
					?>
					<div class="skin-box" id="skin<?php echo $serverSkins[$i]["id"]; ?>" onclick="selectSkinModel(this, <?php echo $serverSkins[$i]["id"]; ?>)" style="background-image: url('https://www.legacy-rp.net/assets/skins_small/<?php echo $serverSkins[$i]["name"]; ?>-240-400.png');"></div>					
					<?php
				}
