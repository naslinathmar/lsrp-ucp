...
{	
	...
	{
		?>
		<div _ngcontent-tnh-c163="" class="skin" style="background-image: url(&quot;https://www.legacy-rp.net/skins/<?php echo $skinlist[$i][1]; ?>-240-400.png&quot;);" onclick="selectSkin2(<?php echo $skinlist[$i][0]; ?>, '<?php echo $skinlist[$i][1]; ?>')"></div>
		<?php
	}
}
