...
<head>
    <meta charset="utf-8">
    <title>Administration | Legacy Roleplay</title>
    <base href="/">
    ...
    <link rel="stylesheet" href="https://www.legacy-rp.net/modules/template/admin/style.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="https://www.legacy-rp.net/js/page.js" defer></script>
    <script src="https://www.legacy-rp.net/js/admin.js" defer></script>
</head>
    ...
    <app-panel _nghost-tnh-c136="">
        ...
        <app-alerts _ngcontent-tnh-c136="" _nghost-tnh-c147="">
            <ul _ngcontent-tnh-c147="" class="message_pop_n_admin" id="message_pop_n_admin">
                <?php if (isset($gabim)) {
                    if (strlen($gabim) > 0) { ?><li _ngcontent-tnh-c147="" class="info"><span _ngcontent-tnh-c147="" class="icon"><i _ngcontent-tnh-c147="" class="fa fa-fw fa-info-circle"></i></span><span _ngcontent-tnh-c147="" translate="" class="message"> <?php echo $gabim; ?> </span></li><?php }
                                                                                                                                                                                                                                                                                            } ?>
