...
<head>
    <meta charset="utf-8">
    <title>Legacy Roleplay | Login</title>
    <base href="/">
	...
	<link rel="stylesheet" href="https://www.legacy-rp.net/login.css">
...
<body>
    ...
    <app-login _nghost-kmh-c138="">
        ...
        <!---->
        <!---->
        <footer _ngcontent-kmh-c138=""><a href="https://www.legacy-rp.net/register"><span style="color:white">Don't have an account? Register here</a></footer>
		</br></br>
