...
{
    header("location: https://www.legacy-rp.net/panel/characters");
    exit;
}
...
<head>
    <meta charset="utf-8">
    <title>Register | Legacy Roleplay</title>
    <base href="/">
    ...
    <style>
        .vc-wrapper[_ngcontent-kmh-c210] {
            ...
            height: 100vh;
            z-index: 2000;
            background: linear-gradient(to bottom, rgba(50, 100, 160, 0.1), rgba(50, 100, 160, 0.1)), url("https://www.legacy-rp.net/assets/images/gunbg.png");
    ...
    <style>
        ...
        header[_ngcontent-kmh-c137] {
            color: #fff;
            z-index: 5;
            background-image: url('https://www.legacy-rp.net/assets/images/serverlogo_big.png');
    ...
    <style>
        ...
        [_nghost-kmh-c138] header[_ngcontent-kmh-c138] {
            background: url("https://www.legacy-rp.net/assets/images/serverlogo_big.png") no-repeat center;
...
<body>
        ...
        <app-register _nghost-kmh-c138="">
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <!---->
                <!---->
                <footer _ngcontent-kmh-c138=""><a href="https://www.legacy-rp.net/login"><span style="color:white">Already have an account? Log In</a></footer>
				</br></br>
