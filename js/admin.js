...
function APPLICATION_CONFIRM() 
{
	...
	hiddenFieldElementID.action = "https://www.legacy-rp.net/modules/template/admin/application/confirm.php";
...
function APPLICATION_DENY() 
{
	...
	hiddenFieldElementID.action = "https://www.legacy-rp.net/modules/template/admin/application/deny.php";
	hiddenFieldElementID.submit();
}
...
function APPLICATION_BAN() 
{
	...
	hiddenFieldElementID.action = "https://www.legacy-rp.net/modules/template/admin/application/ban.php";
	hiddenFieldElementID.submit();
}
