...
function PLAYER_NAMECHANGE(character) 
{
	...
	$("#popup_container").load("https://www.legacy-rp.net/includes/player/namechange.php?char=" + character, function() 
	{
...
function function_AcceptFriend(n) {
	...
	n = "https://www.legacy-rp.net/includes/func_acceptfriend.php?friend=" + n;
	$("#popup_container").load(n)
}

function function_RemoveFriend(n) {
	document.getElementById("popup_container").innerHTML = '<app-popup _nghost-tnh-c158="" class="ng-star-inserted"><div _ngcontent-tnh-c158="" class="popper"><div _ngcontent-tnh-c158="" class="popup"><header _ngcontent-tnh-c158=""><span _ngcontent-tnh-c158=""></span><span _ngcontent-tnh-c158="" class="close" onclick="cancelDialog()"><i _ngcontent-tnh-c158="" class="far fa-fw fa-times"></i></span></header><div _ngcontent-tnh-c158="" class="popup-content"></div></div></div></app-popup>';
	n = "https://www.legacy-rp.net/includes/func_removefriend.php?friend=" + n;
	$("#popup_container").load(n)
}

function function_addFriend() {
	document.getElementById("popup_container").innerHTML = '<app-popup _nghost-tnh-c158="" class="ng-star-inserted"><div _ngcontent-tnh-c158="" class="popper"><div _ngcontent-tnh-c158="" class="popup"><header _ngcontent-tnh-c158=""><span _ngcontent-tnh-c158=""></span><span _ngcontent-tnh-c158="" class="close" onclick="cancelDialog()"><i _ngcontent-tnh-c158="" class="far fa-fw fa-times"></i></span></header><div _ngcontent-tnh-c158="" class="popup-content"></div></div></div></app-popup>';
	$("#popup_container").load("https://www.legacy-rp.net/includes/func_addfriend.php")
}

function nameChange() {
	var n = "https://www.legacy-rp.net/includes/func_namechange.php?char=" + document.getElementById("charname2").innerHTML + "&changename=" + document.getElementById("changeNameInput").value,
...
function addFriend() {
	var n = "https://www.legacy-rp.net/includes/func_addfriend.php?friend=" + document.getElementById("friend_name").value,
		e = document.getElementById("loadingbar");
	e.classList.add("active"), $("#popup_container").load(n, function() {
		e.classList.remove("active")
	})
...
function acceptFriend(n) {
	var n = "https://www.legacy-rp.net/includes/func_acceptfriend.php?friend=" + n + "&accept=1",
		e = document.getElementById("loadingbar");
	e.classList.add("active"), $("#popup_container").load(n, function() {
		e.classList.remove("active")
	})
...
function removeFriend(n) {
	var n = "https://www.legacy-rp.net/includes/func_removefriend.php?friend=" + n + "&remove=1",
		e = document.getElementById("loadingbar");
	e.classList.add("active"), $("#popup_container").load(n, function() {
		e.classList.remove("active")
	})
...
function refreshSkins() {
	var n;
	(idx += 50) < 301 && (n = "https://www.legacy-rp.net/update_skin.php?idx=" + idx, $("#skins_content").load(n))
}

function selectSkin(n, e) {
	var t = "https://www.legacy-rp.net/skins/" + e + "-240-400.png";
...
function saveThisSkin(n) {
	...
	document.location.href = "https://www.legacy-rp.net/panel/change_skin/" + n + "/" + e
}
