...
function changeCurrentPage(fileName, extraid, a = -1) 
{
	...
	if(a != -1)
	{
		...
		switch(a) 
		{
			case 1:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/profile.php?test=" + extraid,
					callback: function() 
					{
			...
			case 2:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/change_skin.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 3:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/inbox.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 4:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/applications.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 5:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/application.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 6:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/vehicle.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 7:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/faction.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 8:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/friends.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 9:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/gov.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 10:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/player/property.php?test=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
	...
	else 
	{
		...
		({
			type: "GET",
			url: "https://www.legacy-rp.net/modules/template/player/" + fileName + ".php",
			callback: function() 
			{
				if(newXHR.readyState == 4 && newXHR.status == 200)
				{
...
function changeCurrentPage_A(fileName, extraid, a = -1) 
{
	...
	if(a != -1)
	{
		...
		switch(a)
		{
			case 1:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/admin/application.php?app_id=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
			...
			case 2:
				...
				({
					type: "GET",
					url: "https://www.legacy-rp.net/modules/template/admin/players.php?app_id=" + extraid,
					callback: function() 
					{
						if(newXHR.readyState == 4 && newXHR.status == 200)
						{
	...
	else 
	{
		...
		({
			type: "GET",
			url: "https://www.legacy-rp.net/modules/template/admin/" + fileName + ".php",
			callback: function() 
			{
				if(newXHR.readyState == 4 && newXHR.status == 200)
				{
