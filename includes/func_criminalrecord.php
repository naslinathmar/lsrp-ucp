...
?>
									...
									<div _ngcontent-tnh-c226="" class="cs-1" style="display: flex;" *ngIf="result">
										<div _ngcontent-tnh-c226="" class="mugshot-background" *ngIf="result.mugshot_skin">
											<div _ngcontent-tnh-c226="" class="mugshot" [ngStyle]="mugshotStyle" style="background-image: url('https://www.legacy-rp.net/skins/<?php echo $skins[ $Model ]; ?>-240-400.png')"> </div> </div>
										<div>
