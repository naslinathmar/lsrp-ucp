...
if(isset($_GET['changename']))
{
	...
	{	
		...
		//header('location: https://www.legacy-rp.net/panel/characters/$changename');
		
		?>
		<form method="POST" action="https://www.legacy-rp.net/panel/characters/<?php echo $changename; ?>" id="changename_form">
