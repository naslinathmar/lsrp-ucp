...
<app-sidepanel _ngcontent-tnh-c136="" _nghost-tnh-c137=""> 					
    <nav _ngcontent-tnh-c137="" id="panel">
        <header _ngcontent-tnh-c137="" routerlink="/panel/characters" style="outline: none; cursor: pointer;" tabindex="0">
            <h1 _ngcontent-tnh-c137="">Legacy Roleplay</h1>
        </header>
        <div _ngcontent-tnh-c137="" class="category-wrapper">
            <div _ngcontent-tnh-c137="" class="category">
                <h2 _ngcontent-tnh-c137="" translate=""> Legacy Roleplay </h2> 
            </div>
		...
		{ 	
			...
			{
				?>
				<!--<div _ngcontent-tnh-c137="" class="adminpanel" onclick="document.location.href='https://www.legacy-rp.net/admin/applications'">
					<a href="javascript:void(0);"><h2 _ngcontent-tnh-c137="" style="opacity: 0;">Administration</h2></a>
				</div>-->									
				<div _ngcontent-tnh-c137="" class="category">
					<a href="https://www.legacy-rp.net/admin/applications"><h2 _ngcontent-tnh-c137="">Administration</h2></a>
				</div>								
				<?php
			}
		}							
		...
		{										
			?>
			<!--<div _ngcontent-tnh-c137="" class="controlpanel" onclick="document.location.href='https://www.legacy-rp.net/panel/characters'">
				<a href="javascript:void(0);"><h2 _ngcontent-tnh-c137="" style="opacity: 0;">Control Panel</h2></a>
			</div>-->				
			<div _ngcontent-tnh-c137="" class="category">
				<a href="https://www.legacy-rp.net/panel/characters"><h2 _ngcontent-tnh-c137="">Control Panel</h2></a>
			</div>									
			<?php								
		}								
		?>								
            ...
            <ul _ngcontent-tnh-c137="" class="menu">
                <li _ngcontent-tnh-c137=""><a _ngcontent-tnh-c137="" href="https://forum.legacy-rp.net" target="_blank"><i _ngcontent-tnh-c137="" class="fa fa-fw fa-comments"></i><span _ngcontent-tnh-c137="" class="link-label">Community Forum</span></a></li>
			...
			<div _ngcontent-tnh-c207="" class="container" id="profile_dropdown" style="display: none;"><?php if($has_avatar) { ?><img _ngcontent-tnh-c207="" class="avatar" src="http://forum.localhost/get_avatar.php?username=<?php echo $username; ?>"><?php } ?>
				...
				for($i = 0; $i < 6; ++$i)
				{
					...
					{												
						...
						?>
						<div _ngcontent-tnh-c207="" class="character" tabindex="0" title="<?php echo $charss[$i][0]; ?>" onClick="changeCurrentPage('characters', '<?php echo $testname; ?>', 1)" style="background-image: url(&quot;https://www.legacy-rp.net/assets/skins_small/<?php echo $skinipau; ?>-240-400.png&quot;);"></div>
						<?php
